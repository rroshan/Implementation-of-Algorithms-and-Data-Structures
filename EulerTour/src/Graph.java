...
public class Graph implements Iterable<Vertex> {
	...
	/*
	 * counting the no. of edges in a given graph 
	 * this count is used verify the tour to make sure every edge is traversed at least once.
	*/
	...
	void addEdge(Vertex from, Vertex to, int weight) {
		...
		if(this.directed) {
			...
			from.adj.add(e);
			to.adj.add(e);
			from.adjMap.put(to, e);
			to.adjMap.put(from, e);
